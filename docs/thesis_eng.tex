...
\bibitem[1]{A} S.Makridakis, S.C. Wheelwright R.J. Hyndman \emph{Forecasting Methids and Applications}, John Wiley \& Sons, 1998, 20--51, 135--177.
\bibitem[2]{B} R. Prado, M. West,  \emph{Time Series: Modeling, Computation and Inference}, CRC Press, 2010, 1--13.
...
\end{figure}
\thispagestyle{empty}
\item To add new resource, click ‘Add New Resource’. 
 Than fill in the form. In the ‘Image’ field, please provide image from your computer library and click 'save'.
...
\item To view resource details, please click the magnifying glass next to it.
...
\item ORDERS
\begin{enumerate}
\item To send order to resource suppliers, please check resources you want to order and fill their quantity in the input box next to resource name.
...
\item REPORT PREDICTION RESOURCE/PRODUCT
\begin{enumerate}
\item To generate forecast report please check resources/products for which you would like to see the report, choose chart type, the last date that will be in the scope of the report, how many days back should the report go and for how many days you would like to generate forecast report. If you want to just display report in the browser - click "generate forecast". If you want to receive report  by an email, fill also "email of receiver" input box and click "send forecast".
...
\end{enumerate}
\item PRODUCTS/RESOURCES CATEGORIES
\begin{enumerate}
\item To manage categories of products/resources, please click on 'manage categories' in the left side menu, and choose products or resources subpage.
\begin{figure}[h!]
\begin{center}
...
\item To add new category, click ‘Add New Category’. Than fill in the form with category name and click 'Save'.
\begin{figure}[h!]
\begin{center}
...
\item To edit notification for chosen resource, please click on the pencil icon next to it. Enter critical value for which notifications will be send and turn notifications on or off.
...
\item To edit supplier, please click on the pencil icon next to it. Enter the changes and click update. 
...
\end{figure}
\thispagestyle{empty}
\item To delete supplier, please click the bin icon next to it and then confirm.
...
\item To add new job, click ‘Add New Job’. Than fill in the form and click 'save'. Username which is displayed in the table next to each job will be added automatically, It will be login of the user adding the job.
\begin{figure}[h!]
\begin{center}
...
\item To add new user, click ‘Add New User’. Than fill in the form and click 'save'.  Note: Be careful while choosing role of the user - especially administrator role gives user access to sensitive data.
...
\item To view chosen user details, please click the magnifying glass next to it.
...
\item To delete user, please click the bin icon next to it and then confirm.
