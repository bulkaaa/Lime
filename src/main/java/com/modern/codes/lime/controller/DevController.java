...
public class DevController {
    ...
    public void resdev(){
        try {
            ...
            getUsedResourcesValues(startDate, endDate, resourceIds);
        } catch (final ParseException e) {
            e.printStackTrace();
        }
    }
    private void getUsedResourcesValues(final Date startDate, final Date endDate, final List<String> resourceIds) {
