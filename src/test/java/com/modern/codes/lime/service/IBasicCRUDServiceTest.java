...
@DataJpaTest
public class IBasicCRUDServiceTest<T, T_POJO, T_DAO extends IBasicCRUDRepository<T, String>, T_SERVICE extends
        BasicCRUDService<T, T_POJO, T_DAO>> {
    @Test
    ...
    public void deleteByIdTest() {
        final T_POJO obj = service.findAll()
                                  .get(0);
        service.delete(((BasicPOJO) obj).getId());
        final T_POJO next_obj = service.findAll()
                                       .get(0);
    ...
    public void equalsTest() {
        final T_POJO obj = service.findAll()
                                  .get(0);
        final T_POJO obj2 = service.findAll()
                                   .get(0);
